...
def check_argv():
    ...
    """
    if len(sys.argv) != 4:
        print '[!] Script should take in 4 arguments and it will be like,\
...
def gen_model_predict():
    ...
    y_pred = dt.fit(data, target).predict(test_data)
    joblib.dump(dt, 'dt.pkl', compress=True)
